CREATE INDEX idx_vacancies_specialization_id ON vacancies(specialization_id); -- поле участвует в JOIN vacancies.specialization_id = specializations.specialization_id
...
CREATE INDEX idx_resumes_specialization_id ON resumes(specialization_id); -- так же как и в vacancies поле нужно для соединения со специализациями
